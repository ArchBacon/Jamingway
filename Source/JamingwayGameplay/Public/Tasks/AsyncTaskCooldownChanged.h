...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnCooldownChanged, FGameplayTag, CooldownTag, float, Duration);
...
class JAMINGWAYGAMEPLAY_API UAsyncTaskCooldownChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
